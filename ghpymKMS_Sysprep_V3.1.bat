@echo off
title E龙のKMS激活脚本V3.1_Sysprep部署版（果核剥壳KMS）
...
goto kmsw
:networkerror
mshta vbscript:msgbox("无法连接至服务器，将尝试进行预配置激活",6,"ghpymKMS_Sysprep部署版_By@E_Dragon_V3.1")(window.close)
goto kmsw
:kmsw
...
goto result
:result
mshta vbscript:msgbox("运行结果：未找到合适对应NT内核版本：%error1%,未找到合适对应Windows版本/Windows已激活：%error2%,未找到合适对应Office版本：%error3%,未找到合适对应Office版本：%error3%,无法激活Office/Office已激活:%error4%。有问题请反馈至我的个人主页edragon.sxl.cn或者我的邮箱e_dragon007@qq.com。程序已运行完成，将进行自我删除qwq",6,"ghpymKMS_Sysprep部署版_By@E_Dragon_V3.1")(window.close)
del %0