...
echo 有问题请留言edragon.sxl.cn或发邮件至e_dragon007@qq.com
echo 本脚本使用了 @果核剥壳 的KMS激活服务器，链接：ghpym.com
echo 本程序发布在果核剥壳且免费开放下载，如需转载请经过作者同意且不要改动文件内容！
echo 　　　　　　　　　　　　██████　
echo 　　　　　██　　　　██　█████　　　　　　　　　　　　　█　　　　　　　　　　　　　　　　
echo 　　　　████　　　████████　　　　　　　　　██　███　　　　　　　　　　　　　　　
echo 　　　　　　　　　　　████████　　　　　　　　████　　　　　　　　　　　　　　　　　　
...
echo [5]清除Windows KMS激活                            [0]访问果核剥壳软件发布帖
...
if /i "%choose%"=="ghpym" cls&goto egg
exit
...
:choose0
start https://www.ghpym.com/ghkmsbat.html
goto begin
...
echo █　　　　　█　　　██　█　█████　　　　　　█　█　　██　　　　
echo ███████　　　█　　█　　　　　███　█　█　██　█　██　　█
echo 恭喜你发现了一个彩蛋，关注个公众号支持一下果核哥哥网站的发展吧awa!
pause
mode con cols=100 lines=30
goto begin